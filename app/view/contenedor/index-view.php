    ...
    <section class="content">
            ...
            <div class="form-group">
                ...
                <span>Filtrar por fecha : </span>
                    <div class="input-group input-group-sm">
                        <input type="date" class="form-control" placeholder="Filtra por fecha" name="q" id='q' onkeyup="load(1);">
                ...
                <div class=" pull-right">
					<a class="btn btn-primary" href="contenedor/create"><i class='fa fa-plus'></i> Nuevo</a>
                    <a href="contenedor/create#"  onclick="print();"  class="btn btn-success"><i class="fa fa-print"></i> Imprimir</a>
                    <div class="btn-group">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            Mostrar <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li class='active' onclick='per_page(15);' id='15'><a href="contenedor/index#">15</a></li>
                            <li  onclick='per_page(25);' id='25'><a href="contenedor/index#">25</a></li>
                            <li onclick='per_page(50);' id='50'><a href="contenedor/index#">50</a></li>
                            <li onclick='per_page(100);' id='100'><a href="contenedor/index#">100</a></li>
                            <li onclick='per_page(1000000);' id='1000000'><a href="contenedor/index#">Todos</a></li>
                        </ul>
                    </div>
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Historial de Contenedores</h3>
...
<script>
    ...
    function load(page){
            ...
            $.get({
                url:"./?action=contenedor&type=index",
                data:parametros,
